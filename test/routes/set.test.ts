...
describe('POST /set', () => {
  describe('when the token is valid', () => {
    ...
    it('returns 204 and sets value', async () => {
    ...
    it('returns 204 and deletes value', async () => {
    ...
    it('returns 400 when the body is not a JSON object', async () => {
      const { response, error } = await set(
        {
          key: 'hello',
          value: 'world',
        },
  ...
  describe('when the token is invalid', () => {
    it('passes 401 and 404 errors through from PFPK auth', async () => {
      ...
      const { response: response1, error: error1 } = await set(
        {
          key: 'hello',
          value: 'world',
        },
      ...
      const { response: response2, error: error2 } = await set(
        {
          key: 'hello',
          value: 'world',
        },
